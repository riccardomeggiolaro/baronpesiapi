...
import { exportCards, getOneCard, listCards, updateCard } from "./cards.controller";
...
router.get("/export-list/:type", isAuthenticated, validate(FilterCardDTO, "query"), canFilterByInstallation(), exportCards); // Check if the user is authenticated, validate the query, check if all filters can be passed and call function exportCards
