...
router.post("/add-installation", isSuperAdmin, validate(InstallationDTO), addInstallation);
...
router.patch("/:id", isSuperAdmin, validate(UpdateDTO), validate(IDInstallationDTO, "params"), updateInstallation);
router.delete("/:id", isSuperAdmin, validate(IDInstallationDTO, "params"), deleteInstallation);
