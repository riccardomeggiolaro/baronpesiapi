...
import { addSubject, listSubjects, updateSubject, deleteSubject } from "./subjects.controller";
...
router.patch("/:id", isAdmin, validate(UpdateSubjectDTO), validate(IDSubjectDTO, "params"), updateSubject); // Check if the user is authenticated, validate body and param and call function udpdateSubject
