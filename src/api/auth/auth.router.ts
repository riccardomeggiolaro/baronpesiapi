...
router.post("/signin/first-user", validate(FirstUserDTO), signinFirstUser); // Validate the body, check if there is just some user and call the function signinFirstUser
